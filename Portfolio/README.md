...
4. Predictive Model on Monthly Retail Sales  [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project4)
...
5. Stroke Prediction based on risk factors  [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project5)
...
6. Sentiment Analysis on iPhone Reviews(Amazon) [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project6)
...
7. Optimal Feature selection to build models [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project7)
...
8. iPhone reviews sentiment analysis  [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project8)
I will be evaluating the overall response of cell phone reviews of previous models of the iPhone from the dataset sourced from the Kaggle website. To be specific, this will be about iphone X/XE/XS/XR models. The objective is to solve the business problem of how to improve the quality of product further considering the customer reviews and help achieve better profits for the future products.

9. Data Visualizations using automobile/car database. [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project9)
...
10. Predict risk variables for heart patients  [Link](https://github.com/anandsarda/Data-Science/tree/main/Portfolio/Project10)
